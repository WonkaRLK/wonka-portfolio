...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[13rem] sm:h-[22rem] md:h-[40rem] w-full border border-white/10 p-1 md:p-6 bg-white/5 backdrop-blur-sm rounded-[30px] shadow-2xl"
    >
